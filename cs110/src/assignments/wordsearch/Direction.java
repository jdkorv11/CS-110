 ...
 * direction. Each direction has a horizontal and vertical step which describes
 * how to increment an index stepping through a word in each dimension. A step
 * is either 0, 1 or -1. For example, the Easterly direction steps +1
 * horizontally and 0 vertically.
 * 
 * @author rgordon
 * 
 */
